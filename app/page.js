...
export default function Home(){
  ...
  return <main>
    ...
    <section className="grid">
      <div className="list">
        <div className="listHead"><div><h2>Search relevance</h2><small>How closely the job matches your Search Profile</small></div><small>Newest {freshnessDays} days</small></div>
      ...
      <div className="panel">
        {active?(()=>{const {job}=active; const expertise=expertiseState.jobKey===jobKey?expertiseState.analysis:null; return <>
          ...
          <div className="expertiseHero">
            <div className="expertiseHeroHead"><div><p className="eyebrow">MATCH CV AND JD</p><p className="expertiseIntro">How closely your CV experience matches the full job description</p></div><div className="expertiseScore">{expertiseState.loading&&expertiseState.jobKey===jobKey?'…':expertise?`${expertise.expertiseMatch}%`:'N/A'}</div></div>
            ...
            {!expertise&&!expertiseState.loading&&<button className="primary" onClick={runExpertiseMatch}>Match CV and JD</button>}
            {expertise&&<>
