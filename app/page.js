...
export default function Home(){
  ...
  return <main>
    <header><div><div className="brand">ApplyPilot</div><div className="tag">Search less. Apply better.</div></div><div style={{color:'#7ee2b8',fontSize:'11px',fontWeight:850}}>{resumeLoaded?'Profile ready':'Profile empty'}</div><div className="headerActions"><div className="sourceBadge">LINKEDIN · PUBLIC</div></div></header>
