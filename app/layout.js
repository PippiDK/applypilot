...
import StablePreviewOrigin from './components/stable-preview-origin.js'
...
export default function RootLayout({children}){
  ...
  return <html lang="en"><body><StablePreviewOrigin environment={environment} branchUrl={branchUrl}/><SplashGate>{children}<NightFlightDrawer><NightFlightMorningReview/><NightFlightSettings/></NightFlightDrawer><NeutralizeLegacyTestLabels/><div className="versionBadge">{versionLabel}</div><SignOutButton/></SplashGate></body></html>
}
