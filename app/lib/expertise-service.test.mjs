...
const aiResult={requirements:[
  {id:'delivery',capability:'End-to-end AI delivery',category:'delivery_execution',importance:'core',requirement:'Lead end-to-end delivery of AI initiatives.',minimumYears:0,evidenceRule:'all_groups',evidenceGroups:[{label:'AI delivery',directEvidenceTerms:['AI delivery'],transferableEvidenceTerms:['end-to-end delivery']}],directEvidenceTerms:['AI delivery'],transferableEvidenceTerms:['end-to-end delivery'],jdEvidence:['Lead end-to-end delivery of AI initiatives.']},
  {id:'genai',capability:'Generative AI delivery',category:'technical_platform_capabilities',importance:'critical',requirement:'Experience delivering Generative AI solutions is required.',minimumYears:0,evidenceRule:'all_groups',evidenceGroups:[{label:'Generative AI',directEvidenceTerms:['Generative AI'],transferableEvidenceTerms:['data platform']}],directEvidenceTerms:['Generative AI'],transferableEvidenceTerms:['data platform'],jdEvidence:['Experience delivering Generative AI solutions is required.']},
  {id:'stake',capability:'Senior stakeholder leadership',category:'leadership_stakeholder_scope',importance:'core',requirement:'Build strong relationships with senior stakeholders.',minimumYears:0,evidenceRule:'all_groups',evidenceGroups:[{label:'senior stakeholders',directEvidenceTerms:['senior stakeholders','executive reporting'],transferableEvidenceTerms:['stakeholder management']}],directEvidenceTerms:['senior stakeholders','executive reporting'],transferableEvidenceTerms:['stakeholder management'],jdEvidence:['Build strong relationships with senior stakeholders.']}
]}
